...
module.exports = {
    ...
    navLinks: [
        ...
        { enabled: false, text: 'Github', url: '', icon: 'github' },          // add your GitHub URL and set enabled: true
    ...
    // -------------------------------------------------------------------
    projects: [
        { code: 'mrdn',  enabled: true, online: true,  url: 'https://meridian-fawn-alpha.vercel.app/', name: 'Meridian Health Records', description: 'A secure patient information system for clinics and care teams, built on Spring Boot and React. Role-based access control, full audit logging, and encrypted sessions protect every patient record, procedure, and visit, with an interface in English, Spanish, and French. Deploys self-hosted or fully serverless on Vercel', icon: 'hospital-fill' },
        { code: 'cgac',  enabled: true, online: true,  url: 'https://coingecko-api-client-six.vercel.app/', name: 'Crypto Market Watch', description: 'A modern web application that integrates CoinGecko API data to display cryptocurrency market information and price charts', icon: 'currency-bitcoin' },
